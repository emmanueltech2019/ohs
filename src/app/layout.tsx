...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
      <meta name="google-site-verification" content="BNxvVmfKKgBkvTwbBXx2thIvTDyJiGmXShmfHgE_7To" />
      <script async src="https://www.googletagmanager.com/gtag/js?id=G-LZYQG5WV1Y"></script>
        <script
